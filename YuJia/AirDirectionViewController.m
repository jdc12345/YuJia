...
@interface AirDirectionViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation AirDirectionViewController
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        ...
        [_tableView registerClass:[AirDirectionTableViewCell class] forCellReuseIdentifier:@"AirDirectionTableViewCell"];
...
- (void)viewDidLoad {
    ...
    self.dataSource = [[NSMutableArray alloc]initWithArray:@[@"自动",@"上下风",@"左右风"]];
    self.iconList =@[@"self-motion_small",@"cold_small",@"hot_small"];
    [self tableView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    AirDirectionTableViewCell *homeTableViewCell = [tableView dequeueReusableCellWithIdentifier:@"AirDirectionTableViewCell" forIndexPath:indexPath];
