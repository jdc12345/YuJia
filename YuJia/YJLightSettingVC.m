...
@interface YJLightSettingVC ()

@end

@implementation YJLightSettingVC
...
- (void)setSubView{
    ...
    imageV.image = [UIImage imageNamed:@"equipment_set_lightbig"];
    ...
    leftImageV.image = [UIImage imageNamed:@"equipment_set_dark"];
    ...
    rightImageV.image = [UIImage imageNamed:@"equipment_set_bright"];
