//
//  CurtainSettingViewController.m
//  YuJia
//
...
#import "MMSlider.h"
@interface CurtainSettingViewController ()

@end

@implementation CurtainSettingViewController
...
- (void)setSubView{
    ...
    imageV.image = [UIImage imageNamed:@"curtain-big"];
    ...
    leftImageV.image = [UIImage imageNamed:@"close"];
    ...
    rightImageV.image = [UIImage imageNamed:@"open"];
