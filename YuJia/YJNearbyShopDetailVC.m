...
http://192.168.1.55:8080/smarthome/mobileapi/business/findbusinessOne.do?
    ...
    NSString *bussinessUrlStr = [NSString stringWithFormat:@"%@/mobileapi/business/findbusinessOne.do?businessId=%ld&token=%@",mPrefixUrl,info_id,mDefineToken1];
...
- (void)setupUI {
    ...
    UILabel *nameLabel = [UILabel labelWithText:self.detailModel.businessName?self.detailModel.businessName:@"西饼店" andTextColor:[UIColor colorWithHexString:@"#333333"] andFontSize:15];//西饼店
